...
def render_start_html() -> str:
    return "\n".join(
        [
            "<b>Админка</b>",
            "",
            "Отчёт - скачать HTML со всеми диалогами.",
            "Статистика - посмотреть общую статистику и когорты за 14 дней.",
            "Юзеры - посмотреть пользователей по дням за последние 14 дней.",
            "Линк - создать ссылку с источником для канала.",
            "Диалог - выгрузить диалог по username или chat_id.",
            "Пинги - задать три интервала в часах.",
            "Алерт - уведомить обоих админов после заданного числа новых пользователей.",
