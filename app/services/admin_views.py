...
def render_start_html() -> str:
    return "\n".join(
        [
            "<b>Админка</b>",
            "",
            "Для того, чтобы импортировать старых юзеров, отправьте команду /import.",
            "",
            "Скачать таблицу - скачать CSV-таблицу лидов.",
            "Статистика - посмотреть HTML-статистику воронки.",
            "Кампания - статус, настройка, пауза и возобновление кампании.",
            "Диалог - выгрузить диалог по username или chat_id.",
            "Стоп - аварийно остановить клиентского бота и follow-up.",
        ]
    )
